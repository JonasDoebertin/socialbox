...
<div class="socialbox-help  socialbox-options">

	<!-- ToC -->
	<div class="socialbox-options__section  socialbox-options__section--header  socialbox-options__section--toc">
		<h3><?php _e('What do you need help with?', 'socialbox') ?></h3>
		<p class="socialbox-options__section__description"><?php _e('Choose the help section you\'d like to see.', 'socialbox') ?></p>
		<ul>
			<li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Facebook Setup', 'socialbox') ?>" href="#facebook" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/facebook.png" alt="<?php _e('Facebook Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Twitter Setup', 'socialbox') ?>" href="#twitter" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/twitter.png" alt="<?php _e('Twitter Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Google+ Setup', 'socialbox') ?>" href="#googleplus" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/googleplus.png" alt="<?php _e('Google+ Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Youtube Setup', 'socialbox') ?>" href="#youtube" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/youtube.png" alt="<?php _e('Youtube Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Vimeo Setup', 'socialbox') ?>" href="#vimeo" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/vimeo.png" alt="Vimeo Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Instagram Setup', 'socialbox') ?>" href="#instagram" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/instagram.png" alt="<?php _e('Instagram Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Pinterest Setup', 'socialbox') ?>" href="#pinterest" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/pinterest.png" alt="<?php _e('Pinterest Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('SoundCloud Setup', 'socialbox') ?>" href="#soundcloud" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/soundcloud.png" alt="<?php _e('SoundCloud Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Dribbble Setup', 'socialbox') ?>" href="#dribbble" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/dribbble.png" alt="<?php _e('Dribbble Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Forrst Setup', 'socialbox') ?>" href="#forrst" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/forrst.png" alt="<?php _e('Forrst Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('Github Setup', 'socialbox') ?>" href="#github" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/github.png" alt="<?php _e('Github Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('MailChimp Setup', 'socialbox') ?>" href="#mailchimp" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/mailchimp.png" alt="<?php _e('MailChimp Setup', 'socialbox') ?>" />
				</a>
			</li><!--
			--><li>
				<a class="js-socialbox-toc-item" data-tooltip="<?php _e('WordPress Plugin Repository Setup', 'socialbox') ?>" href="#wptally" data-scroll>
					<img src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/toc/wptally.png" alt="<?php _e('WordPress Plugin Repository Setup', 'socialbox') ?>" />
				</a>
			</li>
		</ul>
	</div>
	...
	<div class="socialbox-help-section--quick" id="quicksetup">
	...
	<div class="socialbox-help-section--widget" id="widgetoptions">
	...
	<div class="socialbox-help-section--networks" id="networkoptions">
		<h3><?php _e('General Network Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="facebook">
		<h3><?php _e('Facebook Setup', 'socialbox'); ?></h3>
		...
		<h4><?php _e('App ID & Secret', 'socialbox'); ?></h4>
		<p><?php _e('Entering an App ID and the related App Secret is optional until April 30th, 2015. At this date, changes to the API Socialbox uses will take effect. However, if you want to be on the save side, you should obtain and enter App credentials right now. Just follow these steps:', 'socialbox'); ?></p>
		<ol>
			<li><p><?php printf(__('Visit %s Facebook Developers %s and sign in with your Facebook account.', 'socialbox'), '<a href="https://developers.facebook.com/">', '</a>'); ?></p></li>
			<li><p><?php _e('Click &raquo;Apps&laquo; > &raquo;Create a New App&laquo;.', 'socialbox'); ?></p></li>
			<li><p><?php _e('Enter a &raquo;Name&laquo;, choose a &raquo;Category&laquo; and click &raquo;Create App&laquo;.', 'socialbox'); ?></p></li>
			<li><p><?php _e('At the top of the apps overview page you\'ll see your &raquo;App ID&laquo; and &raquo;App Secret&laquo;.', 'socialbox'); ?></p></li>
			<li><p><?php _e('Copy the &raquo;App ID&laquo; and &raquo;App Secret&laquo; values and enter them in the respective fields within SocialBox.', 'socialbox'); ?></p></li>
		</ol>
	</div>

	<div class="socialbox-help-section--networks" id="twitter">
		<h3><?php _e('Twitter Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="googleplus">
		<h3><?php _e('Google+ Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="youtube">
		<h3><?php _e('Youtube Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="vimeo">
		<h3><?php _e('Vimeo Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="instagram">
		<h3><?php _e('Instagram Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="pinterest">
		<h3><?php _e('Pinterest Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="soundcloud">
		<h3><?php _e('SoundCloud Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="dribbble">
		<h3><?php _e('Dribbble Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="forrst">
		<h3><?php _e('Forst Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="github">
		<h3><?php _e('Github Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="mailchimp">
		<h3><?php _e('MailChimp Setup', 'socialbox'); ?></h3>
	...
	<div class="socialbox-help-section--networks" id="wptally">
		<h3><?php _e('WordPress Plugin Repository Setup', 'socialbox'); ?></h3>

		<img class="socialbox-help-image--center" src="<?php echo JD_SOCIALBOX_URL ?>/assets/img/help/wptally-settings.png" alt="WordPress Plugin Repository Settings" />
		<h4><?php _e('Username', 'socialbox'); ?></h4>
		<p><?php _e('Please enter your WordPress.org username of the account you want to showcase.', 'socialbox'); ?></p>

		<h4><?php _e('Metric', 'socialbox'); ?></h4>
		<p><?php _e('You can choose between displaying the number of plugins the user has created and the number of downloads for all the users plugins summed up.', 'socialbox'); ?></p>
	</div>
